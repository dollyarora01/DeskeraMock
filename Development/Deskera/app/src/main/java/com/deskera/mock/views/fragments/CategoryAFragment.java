 ...
 */
public class CategoryAFragment extends BaseItemFragment {

    public CategoryAFragment() {
    }

    @Override
    public void getItemDetails(Long userId) {
        itemsViewModel.getItemsByCategory(userId, 1L).subscribe(new Subscriber<List<Item>>() {
            @Override
