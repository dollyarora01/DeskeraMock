...
public class TableItemsAdapter extends RecyclerView.Adapter<ItemsViewHolder> {

    List<Item> items;
    private OnItemClickListener<Item> onItemClickListener;

    public TableItemsAdapter(List<Item> itemList, OnItemClickListener<Item> itemOnItemClickListener) {
        this.items = itemList;
